------------------------------------------------------
-- This script will create the database 'Northwind' --
------------------------------------------------------
...
GO
	...
	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Ana Trujillo Emparedados y helados','Ana Trujillo','Avda. de la Constitucion 2222','Mexico D.F.','05021','Mexico')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Antonio Moreno Taqueria','Antonio Moreno','Mataderos 2312','Mexico D.F.','05023','Mexico')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Around the Horn','Thomas Hardy','120 Hanover Sq.','London','WA1 1DP','UK')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Berglunds snabbkop','Christina Berglund','Berguvsvagen 8','Lulea','S-958 22','Sweden')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Blauer See Delikatessen','Hanna Moos','Forsterstr. 57','Mannheim','68306','Germany')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Blondel','Frederique Citeaux','24, place Kleber','Strasbourg','67000','France')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Bolido Comidas preparadas','Martin Sommer','Araquil, 67','Madrid','28023','Spain')
	...
	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Centro comercial Moctezuma','Francisco Chang','Sierras de Granada 9993','Mexico D.F.','05022','Mexico')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Chop-suey Chinese','Yang Wang','Hauptstr. 29','Bern','3012','Switzerland')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Comercio Mineiro','Pedro Afonso','Av. dos Lusiadas, 23','Sao Paulo','05432-043','Brazil')
	...
	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Familia Arquibaldo','Aria Cruz','Rua Oros, 92','Sao Paulo','05442-030','Brazil')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('FISSA Fabrica Inter. Salchichas S.A.','Diego Roel','Moralzarzal, 86','Madrid','28034','Spain')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Folies gourmandes','Martine Rance','184, chaussee de Tournai','Lille','59000','France')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Folk och fa HB','Maria Larsson','Akergatan 24','Bracke','S-844 67','Sweden')
	...
	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Galeria del gastronomo','Eduardo Saavedra','Rambla de Cataluña, 23','Barcelona','08022','Spain')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Godos Cocina Tipica','Jose Pedro Freyre','Romero, 33','Sevilla','41101','Spain')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Gourmet Lanchonetes','Andre Fonseca','Av. Brasil, 442','Campinas','04876-786','Brazil')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Great Lakes Food Market','Howard Snyder','2732 Baker Blvd.','Eugene','97403','USA')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('GROSELLA-Restaurante','Manuel Pereira','5A Ave. Los Palos Grandes','Caracas','1081','Venezuela')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Hanari Carnes','Mario Pontes','Rua do Paco, 67','Rio de Janeiro','05454-876','Brazil')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('HILARIoN-Abastos','Carlos Hernandez','Carrera 22 con Ave. Carlos Soublette #8-35','San Cristobal','5022','Venezuela')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Hungry Coyote Import Store','Yoshi Latimer','City Center Plaza 516 Main St.','Elgin','97827','USA')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Hungry Owl All-Night Grocers','Patricia McKenna','8 Johnstown Road','Cork',NULL,'Ireland')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Island Trading','Helen Bennett','Garden House Crowther Way','Cowes','PO31 7PJ','UK')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Koniglich Essen','Philip Cramer','Maubelstr. 90','Brandenburg','14776','Germany')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('La corne dabondance','Daniel Tonini','67, avenue de Europe','Versailles','78000','France')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('La maison dAsie','Annette Roulet','1 rue Alsace-Lorraine','Toulouse','31000','France')
	...
	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Lets Stop N Shop','Jaime Yorres','87 Polk St. Suite 5','San Francisco','94117','USA')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('LILA-Supermercado','Carlos Gonzalez','Carrera 52 con Ave. Bolivar #65-98 Llano Largo','Barquisimeto','3508','Venezuela')
	...
	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Mere Paillarde','Jean Fresniere','43 rue St. Laurent','Montreal','H1J 1C3','Canada')
	...
	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Oceano Atlantico Ltda.','Yvonne Moncada','Ing. Gustavo Moncada 8585 Piso 20-A','Buenos Aires','1010','Argentina')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Old World Delicatessen','Rene Phillips','2743 Bering St.','Anchorage','99508','USA')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Ottilies Kaseladen','Henriette Pfalzheim','Mehrheimerstr. 369','Koln','50739','Germany')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Paris specialites','Marie Bertrand','265, boulevard Charonne','Paris','75012','France')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Pericles Comidas clasicas','Guillermo Fernandez','Calle Dr. Jorge Cash 321','Mexico D.F.','05033','Mexico')
	...
	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Que Delicia','Bernardo Batista','Rua da Panificadora, 12','Rio de Janeiro','02389-673','Brazil')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Queen Cozinha','Lúcia Carvalho','Alameda dos Canarios, 891','Sao Paulo','05487-020','Brazil')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('QUICK-Stop','Horst Kloss','Taucherstrasse 10','Cunewalde','01307','Germany')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Rancho grande','Sergio Gutierrez','Av. del Libertador 900','Buenos Aires','1010','Argentina')
	...
	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Richter Supermarkt','Michael Holz','Grenzacherweg 237','Geneve','1203','Switzerland')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Romero y tomillo','Alejandra Camino','Gran Via, 1','Madrid','28001','Spain')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Sante Gourmet','Jonas Bergulfsen','Erling Skakkes gate 78','Stavern','4110','Norway')
	...
	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Simons bistro','Jytte Petersen','Vinbæltet 34','Kobenhavn','1734','Denmark')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Specialites du monde','Dominique Perrier','25, rue Lauriston','Paris','75016','France')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Split Rail Beer & Ale','Art Braunschweiger','P.O. Box 555','Lander','82520','USA')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Supremes delices','Pascale Cartrain','Boulevard Tirou, 255','Charleroi','B-6000','Belgium')
	...
	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Toms Spezialitaten','Karin Josephs','Luisenstr. 48','Munster','44087','Germany')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Tortuga Restaurante','Miguel Angel Paolino','Avda. Azteca 123','Mexico D.F.','05033','Mexico')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Tradicao Hipermercados','Anabela Domingues','Av. Ines de Castro, 414','Sao Paulo','05634-030','Brazil')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Trails Head Gourmet Provisioners','Helvetius Nagy','722 DaVinci Blvd.','Kirkland','98034','USA')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Vaffeljernet','Palle Ibsen','Smagsloget 45','Arhus','8200','Denmark')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Victuailles en stock','Mary Saveley','2, rue du Commerce','Lyon','69004','France')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Vins et alcools Chevalier','Paul Henriot','59 rue de lAbbaye','Reims','51100','France')

	INSERT INTO Customers (CustomerName,ContactName,Address,City,PostalCode,Country)
	VALUES ('Die Wandernde Kuh','Rita Muller','Adenauerallee 900','Stuttgart','70563','Germany')
...
GO
	...
	INSERT INTO Employees (LastName,FirstName,BirthDate,Photo,Notes)
	VALUES ('Fuller','Andrew','1952-02-19','EmpID2.pic','Andrew received his BTS commercial and a Ph.D. in international marketing from the University of Dallas. He is fluent in French and Italian and reads German. He joined the company as a sales representative, was promoted to sales manager and was then named vice president of sales. Andrew is a member of the Sales Management Roundtable, the Seattle Chamber of Commerce, and the Pacific Rim Importers Association.')

	INSERT INTO Employees (LastName,FirstName,BirthDate,Photo,Notes)
	VALUES ('Leverling','Janet','1963-08-30','EmpID3.pic','Janet has a BS degree in chemistry from Boston College). She has also completed a certificate program in food retailing management. Janet was hired as a sales associate and was promoted to sales representative.')

	INSERT INTO Employees (LastName,FirstName,BirthDate,Photo,Notes)
	VALUES ('Peacock','Margaret','1958-09-19','EmpID4.pic','Margaret holds a BA in English literature from Concordia College and an MA from the American Institute of Culinary Arts. She was temporarily assigned to the London office before returning to her permanent post in Seattle.')

	INSERT INTO Employees (LastName,FirstName,BirthDate,Photo,Notes)
	VALUES ('Buchanan','Steven','1955-03-04','EmpID5.pic','Steven Buchanan graduated from St. Andrews University, Scotland, with a BSC degree. Upon joining the company as a sales representative, he spent 6 months in an orientation program at the Seattle office and then returned to his permanent post in London, where he was promoted to sales manager. Mr. Buchanan has completed the courses Successful Telemarketing and International Sales Management. He is fluent in French.')

	INSERT INTO Employees (LastName,FirstName,BirthDate,Photo,Notes)
	VALUES ('Suyama','Michael','1963-07-02','EmpID6.pic','Michael is a graduate of Sussex University (MA, economics) and the University of California at Los Angeles (MBA, marketing). He has also taken the courses Multi-Cultural Selling and Time Management for the Sales Professional. He is fluent in Japanese and can read and write French, Portuguese, and Spanish.')

	INSERT INTO Employees (LastName,FirstName,BirthDate,Photo,Notes)
	VALUES ('King','Robert','1960-05-29','EmpID7.pic','Robert King served in the Peace Corps and traveled extensively before completing his degree in English at the University of Michigan and then joining the company. After completing a course entitled Selling in Europe, he was transferred to the London office.')

	INSERT INTO Employees (LastName,FirstName,BirthDate,Photo,Notes)
	VALUES ('Callahan','Laura','1958-01-09','EmpID8.pic','Laura received a BA in psychology from the University of Washington. She has also completed a course in business French. She reads and writes French.')

	INSERT INTO Employees (LastName,FirstName,BirthDate,Photo,Notes)
	VALUES ('Dodsworth','Anne','1969-07-02','EmpID9.pic','Anne has a BA degree in English from St. Lawrence College. She is fluent in French and German.')

	INSERT INTO Employees (LastName,FirstName,BirthDate,Photo,Notes)
	VALUES ('West','Adam','1928-09-19','EmpID10.pic','An old chum.')
GO
...
GO
	...
	INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price)
	VALUES (4,'Chef Antons Cajun Seasoning',2,2,'48 - 6 oz jars',22)

	INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price)
	VALUES (5,'Chef Antons Gumbo Mix',2,2,'36 boxes',21.35)

	INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price)
	VALUES (6,'Grandmas Boysenberry Spread',3,2,'12 - 8 oz jars',25)

	INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price)
	VALUES (7,'Uncle Bobs Organic Dried Pears',3,7,'12 - 1 lb pkgs.',30)
	...
	INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price)
	VALUES (20,'Sir Rodneys Marmalade',8,3,'30 gift boxes',81)

	INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price)
	VALUES (21,'Sir Rodneys Scones',8,3,'24 pkgs. x 4 pieces',10)

	INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price)
	VALUES (22,'Gustafs Knackebrod',9,5,'24 - 500 g pkgs.',21)

	INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price)
	VALUES (23,'Tunnbrod',9,5,'12 - 250 g pkgs.',9)

	INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price)
	VALUES (24,'Guarana Fantastica',10,1,'12 - 355 ml cans',4.5)

	INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price)
	VALUES (25,'NuNuCa Nuss-Nougat-Creme',11,3,'20 - 450 g glasses',14)

	INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price)
	VALUES (26,'Gumbar Gummibarchen',11,3,'100 - 250 g bags',31.23)

	INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price)
	VALUES (27,'Schoggi Schokolade',11,3,'100 - 100 g pieces',43.9)

	INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price)
	VALUES (28,'Rossle Sauerkraut',12,7,'25 - 825 g cans',45.6)

	INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price)
	VALUES (29,'Thuringer Rostbratwurst',12,6,'50 bags x 30 sausgs.',123.79)
	...
	INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price)
	VALUES (38,'Cote de Blaye',18,1,'12 - 75 cl bottles',263.5)
	...
	INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price)
	VALUES (41,'Jacks New England Clam Chowder',19,8,'12 - 12 oz cans',9.65)
	...
	INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price)
	VALUES (45,'Rogede sild',21,8,'1k pkg.',9.5)
	...
	INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price)
	VALUES (54,'Tourtiere',25,6,'16 pies',7.45)

	INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price)
	VALUES (55,'Pate chinois',25,6,'24 boxes x 2 pies',24)
	...
	INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price)
	VALUES (61,'Sirop derable',29,2,'24 - 500 ml bottles',28.5)
	...
	INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price)
	VALUES (64,'Wimmers gute Semmelknodel',12,5,'20 bags x 4 pieces',33.25)
	...
	INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price)
	VALUES (71,'Flotemysost',15,4,'10 - 500 g pkgs.',21.5)

	INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price)
	VALUES (72,'Mozzarella di Giovanni',14,4,'24 - 200 g pkgs.',34.8)

	INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price)
	VALUES (73,'Rod Kaviar',17,8,'24 - 150 g jars',15)

	INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price)
	VALUES (74,'Longlife Tofu',4,7,'5 kg pkg.',10)

	INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price)
	VALUES (75,'Rhonbrau Klosterbier',12,1,'24 - 0.5 l bottles',7.75)

	INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price)
	VALUES (76,'Lakkalikoori',23,1,'500 ml ',18)

	INSERT INTO Products (ProductID,ProductName,SupplierID,CategoryID,Unit,Price)
	VALUES (77,'Original Frankfurter grune Sosse',12,2,'12 boxes',13)
...
GO
	...
	INSERT INTO Suppliers (SupplierID,SupplierName,ContactName,Address,City,PostalCode,Country,Phone)
	VALUES (3,'Grandma Kellys Homestead','Regina Murphy','707 Oxford Rd.','Ann Arbor','48104','USA','(313) 555-5735') 
	...
	INSERT INTO Suppliers (SupplierID,SupplierName,ContactName,Address,City,PostalCode,Country,Phone)
	VALUES (6,'Mayumis','Mayumi Ohno','92 Setsuko Chuo-ku','Osaka','545','Japan','(06) 431-7877') 

	INSERT INTO Suppliers (SupplierID,SupplierName,ContactName,Address,City,PostalCode,Country,Phone)
	VALUES (7,'Pavlova, Ltd.','Ian Devling','74 Rose St. Moonie Ponds','Melbourne','3058','Australia','(03) 444-2343') 

	INSERT INTO Suppliers (SupplierID,SupplierName,ContactName,Address,City,PostalCode,Country,Phone)
	VALUES (8,'Specialty Biscuits, Ltd.','Peter Wilson','29 Kings Way','Manchester','M14 GSD','UK','(161) 555-4448') 

	INSERT INTO Suppliers (SupplierID,SupplierName,ContactName,Address,City,PostalCode,Country,Phone)
	VALUES (9,'PB Knackebrod AB','Lars Peterson','Kaloadagatan 13','Goteborg','S-345 67','Sweden ','031-987 65 43') 

	INSERT INTO Suppliers (SupplierID,SupplierName,ContactName,Address,City,PostalCode,Country,Phone)
	VALUES (10,'Refrescos Americanas LTDA','Carlos Diaz','Av. das Americanas 12.890','Sao Paulo','5442','Brazil','(11) 555 4640') 

	INSERT INTO Suppliers (SupplierID,SupplierName,ContactName,Address,City,PostalCode,Country,Phone)
	VALUES (11,'Heli Co.','Petra Winkler','Tiergartenstrasse 5','Berlin','10785','Germany','(010) 9984510') 

	INSERT INTO Suppliers (SupplierID,SupplierName,ContactName,Address,City,PostalCode,Country,Phone)
	VALUES (12,'Plutzer AG','Martin Bein','Bogenallee 51','Frankfurt','60439','Germany','(069) 992755') 
	...
	INSERT INTO Suppliers (SupplierID,SupplierName,ContactName,Address,City,PostalCode,Country,Phone)
	VALUES (17,'Svensk Sjofoda AB','Michael Bjorn','Brovallavagen 231','Stockholm','S-123 45','Sweden','08-123 45 67') 

	INSERT INTO Suppliers (SupplierID,SupplierName,ContactName,Address,City,PostalCode,Country,Phone)
	VALUES (18,'Aux joyeux ecclesiastiques','Guylene Nodier','203, Rue des Francs-Bourgeois','Paris','75004','France','(1) 03.83.00.68') 
	...
	INSERT INTO Suppliers (SupplierID,SupplierName,ContactName,Address,City,PostalCode,Country,Phone)
	VALUES (24,'Gday, Mate','Wendy Mackenzie','170 Prince Edward Parade Hunters Hill','Sydney','2042','Australia','(02) 555-5914') 

	INSERT INTO Suppliers (SupplierID,SupplierName,ContactName,Address,City,PostalCode,Country,Phone)
	VALUES (25,'Ma Maison','Jean-Guy Lauzon','2960 Rue St. Laurent','Montreal','H1J 1C3','Canada','(514) 555-9022') 
	...
	INSERT INTO Suppliers (SupplierID,SupplierName,ContactName,Address,City,PostalCode,Country,Phone)
	VALUES (28,'Gai paturage','Eliane Noz','Bat. B 3, rue des Alpes','Annecy','74000','France','38.76.98.06') 

	INSERT INTO Suppliers (SupplierID,SupplierName,ContactName,Address,City,PostalCode,Country,Phone)
	VALUES (29,'Forets derables','Chantal Goulet','148 rue Chasseur','Ste-Hyacinthe','J2S 7S8','Canada','(514) 555-2955')
