...
namespace APTEKA_Software.Controllers
{
    public class AdminController : Controller
    {
        ...
        public AdminController(AuthManager authManager, IUserService userService, IMapper modelMapper, IAdminService adminService)
        {
        ...
        public IActionResult DeleteConfirmed([FromRoute] int id)
        {
            ...
            {
                var user = this.usersService.GetUser(id);
                if (user.UserId != this.authManager.CurrentUser.UserId && !this.authManager.CurrentUser.IsAdmin)
                {
                    throw new UnauthorizedOperationException("Only the owner or an admin can delete this account.");
                }
                this.usersService.DeleteUser(user.UserId, this.authManager.CurrentUser);
        ...
        public IActionResult BlockConfirmed([FromRoute] int id)
        {
            try
            {
                ...
                this.adminService.BlockUser(user.UserId, this.authManager.CurrentUser);
        ...
        public IActionResult UnblockConfirmed([FromRoute] int id)
        {
            try
            {
                ...
                this.adminService.UnblockUser(user.UserId, this.authManager.CurrentUser);
        ...
        public IActionResult PromoteConfirmed([FromRoute] int id)
        {
            try
            {
                ...
                this.adminService.AssignAdminRole(user.UserId, this.authManager.CurrentUser);
        ...
        public IActionResult DemoteConfirmed([FromRoute] int id)
        {
            try
            {
                ...
                this.adminService.RemoveAdminRole(user.UserId, this.authManager.CurrentUser);
