...
namespace OnlineStore_WithOverload.Orders.Abstract
{
    abstract class Order
    {
        ...
        protected readonly List<Product> items;
        ...
        public Product FindProduct(string productName)
        {
            ...
            throw new ArgumentNullException($"No product with name {productName} exists in this order");
        }

        public Product FindProduct(decimal price)
        {
            foreach (var item in this.items)
            {
                if (item.Price == price)
            ...
            throw new ArgumentNullException($"No product with price {price} exists in this order");
        }
