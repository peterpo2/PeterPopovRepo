...
namespace Cosmetics.Tests.Helpers
{
    public class TestData
    {
        public static class CategoryData
        {
            ...
            public static string InvalidName = new string('x', Category.NameMinLength - 1);
        }
        ...
        {
            public static string ValidName = new string('x', Cream.NameMinLength + 1);
            public static string InvalidName = new string('x', Cream.NameMinLength - 1);

            public static string ValidBrand = new string('x', Cream.BrandMinLength + 1);
            public static string InvalidBrand = new string('x', Cream.BrandMinLength - 1);
        }
    }
}
